...
4. Go to your repository GitHub page and open Settings. Check the Pages tab and Build and deployment section. If GitHub Actions option was selected, assets should be deployed to Pages and there will be an URL like `https://<username>.github.io/vanilla-js-boilerplate/`. You can copy this URL and use it with [BotFather](https://t.me/BotFather) bot to create your very own TWA.
